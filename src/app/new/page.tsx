    ...
    <>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="flex h-44 items-center justify-center bg-canvas">
          <ImageIcon size={48} className="text-border" strokeWidth={1.5} />
        </div>
        <div className="px-5 pt-6">
          ...
          <div className="mt-5 space-y-2.5 pb-6">
            {POINTS.map(({ Icon, title, body }) => (
              <div key={title} className="flex items-start gap-3.5 rounded-2xl bg-canvas p-4">
      ...
      <div className="shrink-0 space-y-3 px-5 pb-5 pt-3">
        ...
        <button className="flex h-12 w-full items-center justify-center gap-2 rounded-full border border-border bg-surface text-[14px] font-medium text-navy hover:bg-canvas">
